...
<html lang="en">
	<head>
		<title>EDII - Social Hub</title>

		<!-- BEGIN META -->
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<meta name="keywords" content="your,keywords">
		<meta name="description" content="EDII Social Hub">
		<!-- END META -->
	...
	<body class="menubar-hoverable header-fixed ">
		...
		<section class="section-account">
			<div class="img-backdrop" style="background-image: url('cms_assets/img/img16.jpg')"></div>
            ...
            <div class="col-sm-3">
						...
						<div class="col-sm-6">
							...
							<br/><br/>
							<form class="form floating-label" action="/mod" accept-charset="utf-8" method="post">
